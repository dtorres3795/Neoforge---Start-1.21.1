...
import net.tge11.firstmod.item.custom.BackroomsKeyItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> BACKROOMS_KEY = ITEMS.register("backrooms_key",
            () -> new BackroomsKeyItem(new Item.Properties().stacksTo(1)));
